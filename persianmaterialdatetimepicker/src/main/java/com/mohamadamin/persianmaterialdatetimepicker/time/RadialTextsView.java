...
public class RadialTextsView extends View {
  ...
  public void initialize(Resources res, String[] texts, String[] innerTexts,
    ...
    // Set up the paint.
    int numbersTextColor = res.getColor(R.color.famdtp_numbers_text_color);
    mPaint.setColor(numbersTextColor);
    mPaint.setAntiAlias(true);
    mPaint.setTextAlign(Align.CENTER);

    // Set up the selected paint
    int selectedTextColor = res.getColor(R.color.famdtp_white);
    ...
    if (is24HourMode) {
      mCircleRadiusMultiplier = Float.parseFloat(
              res.getString(R.string.famdtp_circle_radius_multiplier_24HourMode));
    } else {
      mCircleRadiusMultiplier = Float.parseFloat(
              res.getString(R.string.famdtp_circle_radius_multiplier));
    ...
    if (mHasInnerCircle) {
      mNumbersRadiusMultiplier = Float.parseFloat(
              res.getString(R.string.famdtp_numbers_radius_multiplier_outer));
      mTextSizeMultiplier = Float.parseFloat(
              res.getString(R.string.famdtp_text_size_multiplier_outer));
      mInnerNumbersRadiusMultiplier = Float.parseFloat(
              res.getString(R.string.famdtp_numbers_radius_multiplier_inner));
      mInnerTextSizeMultiplier = Float.parseFloat(
              res.getString(R.string.famdtp_text_size_multiplier_inner));

      mInnerTextGridHeights = new float[7];
      mInnerTextGridWidths = new float[7];
    } else {
      mNumbersRadiusMultiplier = Float.parseFloat(
              res.getString(R.string.famdtp_numbers_radius_multiplier_normal));
      mTextSizeMultiplier = Float.parseFloat(
              res.getString(R.string.famdtp_text_size_multiplier_normal));
    }
  ...
  /* package */ void setTheme(Context context, boolean themeDark) {
    ...
    int textColor;
    if (themeDark) {
      textColor = res.getColor(R.color.famdtp_white);
    } else {
      textColor = res.getColor(R.color.famdtp_numbers_text_color);
    }
